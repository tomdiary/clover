...
function clover_theme_scripts() {
  ...
  wp_enqueue_script('lightgallery', 'https://cdn.jsdelivr.net/npm/lightgallery@2.4.0/lightgallery.umd.min.js', array(), '2.4.0', true);
  wp_enqueue_script('overlayscrollbars', 'https://cdn.jsdelivr.net/npm/overlayscrollbars@1.13.1/js/OverlayScrollbars.min.js', array(), '1.13.1', true);
